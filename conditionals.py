...
if torch_lit: # if torch_lit == True, if true 
...
enemy = "goblin"
if enemy != "dragon":
    print("Charge forward, you can take on anything that not a dragon!")

# <= less than or equal to
player_health = 75
if player_health <= 100:
    print("Drink a health potion foir full strength!")

# >= greater than or equal to
player_health = 150
if player_health >= 150:
    print("Eh, you should be fine.")

    
# checking if something fits between a range of 2 numbers.
magic_stones = 10
if magic_stones >= 10 and magic_stones <= 20:
    print("You have enough stone to open the chest")
...
if not is_daytime and dragon_asleep:
    print("Try sneaking into the dragons liar!")

# ELIF - Allows us to account for aditional conditions following the if
# ELIF = Else If
...
# checking some potion strength.
potion_strength = 15

if potion_strength > 20:
    print(":Its a very powerful potion!")
elif potion_strength > 10:
    print("Its a moderately pwoerful potion.")
...
# Chaining together several ELIFs in a single conditional chain
weather = "rainy"
...
if sword_material == "gold":
    print("The sword shines bright!")
elif sword_material == "silver":
    print("That shord is great for will werewolfs and vampires.")
...
# ELSE - covers any condition that is notaccount for in the if and elif. 
# if none of the conditions are true then the else gets hit. 
...
#     print("GO!")
# # nwhat happens if on of the colors isnt selected.
# else:
...
# Checking how people take thier coffee
...
like_sugar = input("Do you like sugar") #looking for a yes or no 
like_milk = input ("Do you like milk")

if like_sugar == "yes" and like_milk == "yes":
    print("Lets get you a Latte!")
elif not like_sugar == "yes" and like_milk == "yes":
    print("Lets get you a americano!")
elif like_sugar == "no" and like_milk == "no":
    print("Lets get you a Black coffee") 
else:
...
to_do_list = []
completed = []
response = input("Would you like to add to your to do list?")
if response == "yes":
    task = input("Have you already finished this task? yes or no")
    if task == "yes":
        completed.append("do the dishes")
    elif task == "no":
        to_do_list.append("do something elkse")
...
# x= 5 y = 10
    x, y = 5, 10
# what is being executed | if this condition |else execute this
